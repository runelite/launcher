...
fetch_jre('WIN64_', '11.0.18+10', 'x64', 'windows')
fetch_jre('WIN32_', '11.0.18+10', 'x86', 'windows')
fetch_jre('MAC_AMD64_', '11.0.18+10', 'x64', 'mac')
fetch_jre('MAC_AARCH64_', '17.0.6+10', 'aarch64', 'mac')
fetch_jre('LINUX_AMD64_', '11.0.18+10', 'x64', 'linux')
fetch_jre('LINUX_AARCH64_', '11.0.18+10', 'aarch64', 'linux')